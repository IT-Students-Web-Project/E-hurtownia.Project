...
namespace E_hurtownia.Controllers
{
    public class UserController : Controller
    {
        ...
        { // ACTION - REGISTER CHECK INITIAL PROCEDURE
            string newUsername = "";
            string newPassword = "";
        ...
        public IActionResult RegisterPersonCheck()
        { // ACTION - REGISTER PERSONAL DATA CHECKING PROCEDURE
            bool isRegisteredByHimself = TempData["isRegisteredByHimself"] != null && TempData["isRegisteredByHimself"].Equals(true);
...
#nullable disable
            ...
            else
            {
                ...
                if (TempData.Keys.Contains("register-group"))
                {
                    string[] newGroupName = (string[])TempData["register-group"];
                    selectedGroup = databaseContext.Groups.Where(g => g.Name == newGroupName[0]).Single().IdGroup;
                }
                ...
                Users customerUser = new Users
                {
                    ...
                    FkGroup = (selectedGroup == null) ? 2 : selectedGroup,
                    Login = newUsername,
        ...
        { // ACTION - CHANGE PASSWORD CHECK & CONFIRM PROCEDURE
            string oldPassword = "";
            string newPassword = "";
